...
<head>
    ...
    <title>Holiday Deals - Travel Business First</title>
...
<body>
    ...
    @if (!empty($bestofactivity))
        ...
        <nav class="container" aria-label="breadcrumb">
            <ol class="breadcrumb tbf-breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="#">Holiday Deals</a></li>
                <li class="breadcrumb-item active" aria-current="page">{{ $bestofactivity->title }}</li>
            </ol>
        </nav>
        ...
        <section class="section-padding border-top">
            <div class="container">
                <div class="row g-md-5">
                    <div class="col-md-8">
                        <h2 class="fw-bold mb-3 mb-md-4">{{ $bestofactivity->package_heading }}</h2>
                        {{-- <div>
                                            ...
                                            <div class="row gx-1 gx-md-3 align-items-center">
                                                ...
                                                <div class="col-5">
                                                    <div class="destination-city">
                                                        <small>Destination <span
                                                                class="d-none d-md-inline">City</span></small>
                                                        <p class="text-truncate mb-0">{{ $destination->to5 }}</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="city-description">
                            ...
                            <div>
                                {!! $bestofactivity->Long_description !!}
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="multi-fare-section">
                            <div class="class-fare-hoiday">
                            ...
                            <div class="enquiry-bottom">
                                ...
                                <a href="tel:+4402037276360"><img src="img/icons/call-white.svg" alt=""> +
                                    020
                                    3727 6360</a>
                            </div>
                        </div>
                        @include('layouts.holidayenquiry', ['bestofactivity' => $bestofactivity])
                    </div>
                </div>
            </div>
        </section>
    ...
    @endif
    <!-- Footer Section -->
    @include('layouts.footer', ['footermenu' => $footermenu])
