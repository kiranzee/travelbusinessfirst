                                                ...
                                                <div class="row g-4">
                                                    ...
                                                    <div class="col-md-4">
                                                        <label class="form-label">Check Out Date <span
                                                                class="mandate">*</span></label>
                                                        <input class="form-control w-100" type="date" required
                                                            placeholder="Email ID" name="checkout" value="">
                                                    </div>
                                                    <div class="col-md-4">
                                                    ...
                                                    <div class="col-md-4">
                                                        <label class="form-label w-100"> Room Type <span
                                                                class="mandate">*</span></label>
                                                        <select class="form-control" id="room_type" name="roomtype"
                                                            required>
                                                    ...
                                                    <div class="col-md-4">
                                                        <label class="form-label w-100"> Adult <span
                                                                class="mandate">*</span></label>
                                                        <select class="form-control" id="adults" name="adultcount"
                                                            required>
                                                            <option value="1">1</option>
                                                            <option value="2">2</option>
                                                            <option value="3">3</option>
                                                    ...
                                                    <div class="col-md-4">
                                                        <label class="form-label w-100"> Child <span
                                                                class="mandate">*</span></label>
                                                        <select class="form-control" id="adults" name="childcount"
                                                            required>
                                                ...
                                                <div class="row g-4">
                                                    ...
                                                    <div class="col-md-4">
                                                        <label class="form-label">Customer Phone <span
                                                                class="mandate">*</span></label>
                                                        <input class="form-control w-100" type="text" required
                                                            placeholder="+44" name="customer_phone" value="">
                                                    </div>
                                                    <div class="col-md-4">
                                ...
                                <ul style="margin: 0px; position: absolute; top: 0px;">
                                    ...
                                    <li style="border-bottom: 1px solid rgb(234, 234, 234); margin: 0px;"><img
                                        ...
                                        <p>4 Nights at Las
                                            ...
                                            Angeles 4* ALL INCLUSIVE Flights + Accomo £989 PP.</p>
                                    </li>
                                    ...
                                    <li style="border-bottom: 1px solid rgb(234, 234, 234); margin: 0px;"><img
                                            src="{{ asset('img/hotel_deals/antigua.jpg') }}" alt="Gran-Canaria"><a
                                            href="#">Starfish
                                    ...
                                    <li style="border-bottom: 1px solid rgb(234, 234, 234); margin: 0px;"><img
                                            src="{{ asset('img/hotel_deals/barbadoos.jpg') }}" alt="Gran-Canaria"><a
                                            href="#">Butterfly Beach
                                            Hotel</a>
