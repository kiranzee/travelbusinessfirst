...
<section class="search-top-section">
    <img src="{{ asset('img/qatar-airways-top-image.webp') }}" class="img-fluid" alt="" height="175px">
...
<nav class="container" aria-label="breadcrumb">
    <ol class="breadcrumb tbf-breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="#">Qatar Airways</a></li>
                ...
                <div>
                    ...
                    <div class="flight-description">
                        <div class="info-text">
                            <div class="row">
                                <div class="col-lg-12">
                                    <p>Qatar airways has established itself as the premier airline amongst a group of
                                        Middle Eastern “super 5 star airlines”. It has been voted the best airline in
                                        the world for 2017, an award it has one 4 times in the past. Qatar airways focus
                                        on offering quality throughout the plane whether you are flying First class or
                                        Economy. The business class cabin is described as a "high-tech oasis" where
                                        passengers can enjoy up to 3,000 in-flight entertainment options. The business
                                        class seats on the Airbus 380 are an amazing 80 inches long (6 ft 8 inches!) and
                                        22 inches wide. The amenity kit for Business Class is full of high quality care
                                        items in an attractive bag made by Bric’s. Even the Economy class has more leg
                                        room and more width then most of the other airlines.</p>

                                    <p>Travel Business First has great discounts with Qatar Airways. Save upto 50% on
                                        over 100 routes offered by Qatar Airways.</p>
                                    <p>You can save upto 50% by booking your flights with Travel Business First. We are
                                        specialists in selling discounted, cheap flights in Business Class, First Class,
                                        Premium Economy and Economy with lowest fare and unbeatable price. Just call now
                                        on 0203 727 6360.</p>
                                </div>
                            </div>
                            <div class="info-text">
                                <div class="row">
                                    <div class="col-lg-4 col-md-12 mb-4 mb-lg-0">
                                        <img src="{{ asset('img/qatar-2.jpg') }}"
                                            class="w-100 shadow-1-strong rounded mb-4"
                                            alt="Qatar Airways Business Class" />
                                    </div>

                                    <div class="col-lg-4 mb-4 mb-lg-0">
                                        <img src="{{ asset('img/qatar-3.jpg') }}"
                                            class="w-100 shadow-1-strong rounded mb-4"
                                            alt="Qatar Airways Business class" />
                                    </div>

                                    <div class="col-lg-4 mb-4 mb-lg-0">
                                        <img src="{{ asset('img/qatar-4.jpg') }}"
                                            class="w-100 shadow-1-strong rounded mb-4"
                                            alt="Qatar Airways Business Class" />
