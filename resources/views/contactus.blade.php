...
<section class="section-padding border-top">
    <div class="container">
        <h2 class="fw-bold mb-3 mb-md-4">Contact Us</h2>

        <div class="row g-md-5">
            <div class="col-md-6">
                <div>

                    <h4>Travel Business First (a Super Destinations Ltd Company) </h4>
                    <span>Sir Robert Peel House, 344-345 High Road, Ilford, Essex, UK IG1 1QP</span>

                    <p><img class="mt-1" src="{{ asset('img/icons/call-now.svg') }}" alt="Phone">
                        <tcxspan tcxhref="02037276360" title="Call  0203 727 6360"> 0203 727 6360
                        </tcxspan>
                        <img class="mt-1" src="{{ asset('img/icons/email-dark.svg') }}" alt="email"> <a
                            target="_blank"
                            href="mailto:info@travelbusinessfirst.co.uk">info@travelbusinessfirst.co.uk</a>
                    </p>

                    <p><i class="fa fa-clock-o fa-fw"></i> 24 hours a day / 7 days a week</p>
                    <section class="our-features" style="border: none !important">
                        <div class="container">
                                ...
                                <div class="col-md-12">
                                    <div id="ouruspCarousel" class="owl-carousel owl-theme">
                                        <div class="item">
                                            <div class="card">
                                                <img class="img-fluid me-3"
                                                    src="{{ asset('img/icons/register-badge.svg') }}" alt="">
                                        ...
                                        <div class="item">
                                            <div class="card">
                                                <img class="img-fluid me-3"
                                                    src="{{ asset('img/icons/call-24.svg') }}" alt="">
                                        ...
                                        <div class="item">
                                            <div class="card">
                                                <img class="img-fluid me-3"
                                                    src="{{ asset('img/icons/payment.svg') }}" alt="">
            ...
            <div class="col-md-6">
                ...
                <div style="width: 100%"><iframe width="100%" height="300"
                        src="https://maps.google.com/maps?width=100%&amp;height=600&amp;hl=en&amp;coord=51.5609094,0.08339279999995597&amp;q=344-348%20High%20Road%20Ilford%20Essex%20IG1%201QP+(super%20destination)&amp;ie=UTF8&amp;t=&amp;z=15&amp;iwloc=B&amp;output=embed"
                        frameborder="0" scrolling="no" marginheight="0" marginwidth="0"><a
                            href="https://www.mapsdirections.info/en/custom-google-maps/">Create a custom Google
                            Map</a> by <a href="https://www.mapsdirections.info/en/">Measure area on
                            map</a></iframe></div>
            </div>
        </div>
    </div>
