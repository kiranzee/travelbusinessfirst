...
<section class="search-top-section">
    <img src="{{ asset('img/etihad-top-image.webp') }}" class="img-fluid" alt="" height="175px">
...
<nav class="container" aria-label="breadcrumb">
    <ol class="breadcrumb tbf-breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="#">Etihad Airways</a></li>
                ...
                <div>
                    ...
                    <div class="flight-description">
                        <div class="info-text">
                            <div class="row">
                                <div class="col-lg-12">
                                    <p>Considered one of the select 5 star rated airlines, Etihad is the flag carrier
                                        and second largest airline of the UAE.
                                        Its has introduced many innovative features which continues to define the high
                                        standards of service they have established.
                                        They were the first to introduce a First class apartment on board there Airbus
                                        380 comprising a private living room, bedroom and bathroom.
                                        It features a two-seater reclining sofa and TV monitor in the lounge, an ensuite
                                        bathroom with shower and a double bed in the bedroom.
                                        The airline claims it is the most luxurious living space in the air. so book
                                        your tickets for Etihad Airways flights from us.</p>

                                    <p>It has also introduced the First Apartment, featuring a reclining chair; a
                                        full-length ottoman which can be transformed into a bed,
                                        a TV monitor which can swing to align itself to the ottoman so that it can be
                                        viewed from the bed; a vanity cabinet and a bar with assorted chilled drinks.
                                        This class was named the world's best first class in 2015. It serves more than
                                        116 destinations around the world.
                                        In the UK it flies from<strong> Manchester,Edinburgh and London</strong>.</p>
                                    <p> As with the other leading middle eastern airlines, Etihad is a major sponsor of
                                        sports and sporting events.
                                        It is the main sponsor of the leading English Premier League Football team,
                                        Manchester City. We are offering cheapest Etihad Airways flights.</p>
                                    <p> Travel Business First has great discounts with Etihad Airways. Save upto 50% on
                                        over 100 routes offered by Etihad Airways flights.</p>
                                </div>
                            </div>
                            <div class="info-text">
                                <div class="row">
                                    <div class="col-lg-4 col-md-12 mb-4 mb-lg-0">
                                        <img src="{{ asset('img/et-1.jpg') }}"
                                            class="w-100 shadow-1-strong rounded mb-4"
                                            alt="Etihad Airways Business Class" />
                                    </div>

                                    <div class="col-lg-4 mb-4 mb-lg-0">
                                        <img src="{{ asset('img/et-2.jpg') }}"
                                            class="w-100 shadow-1-strong rounded mb-4"
                                            alt="Etihad Airways Business Class" />
                                    </div>

                                    <div class="col-lg-4 mb-4 mb-lg-0">
                                        <img src="{{ asset('img/et-3.jpg') }}"
                                            class="w-100 shadow-1-strong rounded mb-4"
                                            alt="Etihad Airways Business Class" />
