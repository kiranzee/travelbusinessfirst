...
<section class="search-top-section">
    <img src="{{ asset('img/emiratesairline-top-image.webp') }}" class="img-fluid" alt="" height="175px">
...
<nav class="container" aria-label="breadcrumb">
    <ol class="breadcrumb tbf-breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="#">Emirates Airlines</a></li>
                ...
                <div>
                    ...
                    <div class="flight-description">
                        <div class="info-text">
                            <div class="row">
                                <div class="col-lg-12">
                                    <p>Renowned for its distinctive logo and sponsorship of major sports events (The
                                        Emirates FA Cup) and of football stadia (the Arsenal FC football ground),
                                        Emirates has established itself as a premier 5 star airline. It is the
                                        world's
                                        fourth largest airline by scheduled revenue passenger-kilo meters flown and
                                        the
                                        fourth-largest in terms of international passengers carried. Do contact us
                                        now
                                        for the best deals for emirates airlines ticket.</p>
                                    <h3>Why Emirates</h3>
                                    Emirates operate a mixed fleet of Airbus and Boeing wide-body aircraft and is
                                    one of the few airlines to operate an all-wide-body aircraft fleet. The airline
                                    is the largest Airbus A380 operator with more than 100 planes in service. Since
                                    their introduction, the Airbus A380 has become an integral part of Emirates
                                    fleet, and attracts passenger bookings by its sheer quality of experience.
                                    Emirates are also the world's largest Boeing 777 operator.
                                    <p>Emirates has its hub at Dubai International Airport, where Terminal 3 was
                                        built exclusively for the use of Emirates. Terminal 3 is the second largest
                                        building in the world by floor space, Emirates has been consistently ranked
                                        one of the best airlines in the world. Trip advisor voted Emirates best
                                        airline in the world for 2017 by traveller’s choice</p>
                                    <p>
                                        Travel Business First has great discounts with Emirates Airways. Save upto
                                        50% on over 100 routes offered by Emirates Airways.</p>
                                    <p>We are specialists in providing discounted emirates airlines tickets. Whether
                                        you are looking for a cheap flight in Business Class, First Class or
                                        Economy, Travel Business First Can save you upto 50% on over 100 routes
                                        offered by Emirates.</p>
                                </div>
                            </div>
                            <div class="qt-photo-gallery-single qt-photo-gallery">

                                <div class="row">
                                    <div class="col-md-12 col-sm-12">
                                        <a class="qt-fade qt-photo-item" href="#">
                                            <img class="w-100" src="{{ asset('img/emiratesairlines.png') }}"
                                                alt="Emirates Airlines Ticket">
                                        </a>
                                    </div>
