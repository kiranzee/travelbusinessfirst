...
<div class="container mt-5">
    ...
    <form action="{{ route('clientsay.update', $clientsay->id) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="title" name="title" value="{{ old('title', $clientsay->title) }}" required>
        </div>
        ...
        <div class="form-group">
            <div class="row">
                ...
                <div class="col-md-6"><img src="{{ asset('uploads/' . $clientsay->image) }}" alt="{{ $clientsay->name }}" class="img-fluid" style="max-width: 100%; height: auto;" /></div>
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="comments" name="comments" value="{{ old('comments', $clientsay->comments) }}" required>
        </div>
