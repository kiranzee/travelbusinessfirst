...
<section class="search-top-section">
    <img src="{{ asset('img/flight-search-top-image.webp') }}" class="img-fluid" alt="" height="175px">
...
<nav class="container" aria-label="breadcrumb">
    <ol class="breadcrumb tbf-breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="{{ url('/flight') }}">Flight</a></li>
            ...
            <div class="col-md-8">
                ...
                <div>
                    ...
                    <div class="flight-description">
                        <h4>Book Business Class Flights at discounted rates</h4>

                        <div class="info-text">
                            <div class="row">
                                <div class="col-lg-4 col-md-12 mb-4 mb-lg-0">
                                    <img src="{{ asset('img/business-class-flight.webp') }}"
                                        class="w-100 shadow-1-strong rounded mb-4" alt="Business Class Flight" />

                                    <img src="{{ asset('img/business-class-service.webp') }}"
                                        class="w-100 shadow-1-strong rounded mb-4" alt="Business Class Flight" />
                                </div>

                                <div class="col-lg-4 mb-4 mb-lg-0">
                                    <img src="{{ asset('img/business-class-waiting-area.webp') }}"
                                        class="w-100 shadow-1-strong rounded mb-4" alt="Business Class Flight" />

                                    <img src="{{ asset('img/business-class-lounge.webp') }}"
                                        class="w-100 shadow-1-strong rounded mb-4" alt="Business Class Flight" />
                                </div>

                                <div class="col-lg-4 mb-4 mb-lg-0">
                                    <img src="{{ asset('img/business-class-food-service.webp') }}"
                                        class="w-100 shadow-1-strong rounded mb-4" alt="Business Class Flight" />

                                    <img src="{{ asset('img/businessclass-4.webp') }}"
                                        class="w-100 shadow-1-strong rounded mb-4" alt="Business Class Flight" />
                                </div>
                            </div>
                            <div class="row">
                                    ...
                                    @foreach ($popularDestinations->chunk(10) as $chunkedDestinations)
                                        <div class="col-3 col-md-3">
                                            @foreach ($chunkedDestinations as $destination)
                                                <a
                                                    href="{{ route('flight-city-search.citySearch', ['cityname' => $destination->link_name]) }}"><strong>
                                                        {{ $destination->title }}</strong> </a>from <strong>
                                                    £{{ number_format($destination->business_class_price, 0) }}</strong><br />
                                            @endforeach
                                        </div>
                                    @endforeach
                                @else
                ...
                <div>
                    ...
                    <div class="flight-description">
                        <h4>Book First Class Flights at discounted rates</h4>

                        <div class="info-text">
                            <div class="row">
                                <div class="col-lg-4 col-md-12 mb-4 mb-lg-0">
                                    <img src="{{ asset('img/firstclass-1.webp') }}"
                                        class="w-100 shadow-1-strong rounded mb-4" alt="First Class Flight" />

                                    <img src="{{ asset('img/firstclass-2.webp') }}"
                                        class="w-100 shadow-1-strong rounded mb-4" alt="First Class Flight" />
                                </div>

                                <div class="col-lg-4 mb-4 mb-lg-0">
                                    <img src="{{ asset('img/firstclass-3.webp') }}"
                                        class="w-100 shadow-1-strong rounded mb-4" alt="First Class Flight" />

                                    <img src="{{ asset('img/firstclass-4.webp') }}"
                                        class="w-100 shadow-1-strong rounded mb-4" alt="First Class Flight" />
                                </div>

                                <div class="col-lg-4 mb-4 mb-lg-0">
                                    <img src="{{ asset('img/firstclass-5.webp') }}"
                                        class="w-100 shadow-1-strong rounded mb-4" alt="First Class Flight" />

                                    <img src="{{ asset('img/firstclass-6.webp') }}"
                                        class="w-100 shadow-1-strong rounded mb-4" alt="First Class Flight" />
                                </div>
                            </div>
                            <div class="row">
                                        ...
                                        <div class="col-3 col-md-3">
                                            @foreach ($chunkedDestinations as $destination)
                                                <a
                                                    href="{{ route('flight-city-search.citySearch', ['cityname' => $destination->link_name]) }}"><strong>
                                                        {{ $destination->title }}</strong> </a>from <strong>
                                                    £{{ number_format($destination->first_class_price, 0) }}</strong><br />
                                            @endforeach
                                        </div>
                                    @endforeach
                                @else
                ...
                <div>
                    ...
                    <div class="flight-description">
                        <h4>Book Premium Economy Class Flights at discounted rates</h4>

                        <div class="info-text">
                            <div class="row">
                                <div class="col-lg-4 col-md-12 mb-4 mb-lg-0">
                                    <img src="{{ asset('img/premiumeconomy-1.webp') }}"
                                        class="w-100 shadow-1-strong rounded mb-4"
                                        alt="Premium Economy Class Flight" />

                                    <img src="{{ asset('img/premiumeconomy-2.webp') }}"
                                        class="w-100 shadow-1-strong rounded mb-4"
                                        alt="Premium Economy Class Flight" />
                                </div>

                                <div class="col-lg-4 mb-4 mb-lg-0">
                                    <img src="{{ asset('img/premiumeconomy-3.webp') }}"
                                        class="w-100 shadow-1-strong rounded mb-4"
                                        alt="Premium Economy Class Flight" />

                                    <img src="{{ asset('img/premiumeconomy-4.webp') }}"
                                        class="w-100 shadow-1-strong rounded mb-4"
                                        alt="Premium Economy Class Flight" />
                                </div>

                                <div class="col-lg-4 mb-4 mb-lg-0">
                                    <img src="{{ asset('img/premiumeconomy-5.webp') }}"
                                        class="w-100 shadow-1-strong rounded mb-4"
                                        alt="Premium Economy Class Flight" />

                                    <img src="{{ asset('img/premiumeconomy-6.webp') }}"
                                        class="w-100 shadow-1-strong rounded mb-4"
                                        alt="Premium Economy Class Flight" />
                                </div>
                            </div>
                                        ...
                                        <div class="col-3 col-md-3">
                                            @foreach ($chunkedDestinations as $destination)
                                                <a
                                                    href="{{ route('flight-city-search.citySearch', ['cityname' => $destination->link_name]) }}"><strong>
                                                        {{ $destination->title }}</strong> </a>from <strong>
                                                    £{{ number_format($destination->premier_economy_price, 0) }}</strong><br />
                                            @endforeach
                                        </div>
                                    @endforeach
                                @else
                ...
                <div>
                    ...
                    <div class="flight-description">
                        <h4>Book Economy Class Flights at discounted rates</h4>

                        <div class="info-text">
                            <div class="row">
                                <div class="col-lg-4 col-md-12 mb-4 mb-lg-0">
                                    <img src="{{ asset('img/economy-1.webp') }}"
                                        class="w-100 shadow-1-strong rounded mb-4" alt="Economy Class Flight" />
                                </div>

                                <div class="col-lg-4 mb-4 mb-lg-0">
                                    <img src="{{ asset('img/economy-2.webp') }}"
                                        class="w-100 shadow-1-strong rounded mb-4" alt="Economy Class Flight" />
                                </div>

                                <div class="col-lg-4 mb-4 mb-lg-0">
                                    <img src="{{ asset('img/economy-3.webp') }}"
                                        class="w-100 shadow-1-strong rounded mb-4" alt="Economy Class Flight" />
                                        ...
                                        <div class="col-3 col-md-3">
                                            @foreach ($chunkedDestinations as $destination)
                                                <a
                                                    href="{{ route('flight-city-search.citySearch', ['cityname' => $destination->link_name]) }}"><strong>
                                                        {{ $destination->title }}</strong></a> from <strong>
                                                    £{{ number_format($destination->economy_price, 0) }}</strong><br />
                                            @endforeach
                                        </div>
                                    @endforeach
                                @else
