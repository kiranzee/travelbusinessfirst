            ...
            <tbody>
                @foreach ($topthingstodo as $topthings)
                    <tr>
                        ...
                        <td><img src="{{ asset('uploads/' . $topthings->image) }}" alt="{{ $topthings->title }}"
                        ...
                        <td>
                            <!-- Edit button -->
                            <a href="{{ route('topthingstodo.edit', $topthings->id) }}"
                                class="btn btn-sm btn-warning">Edit</a>

                            <!-- Delete button -->
                            <form action="{{ route('topthingstodo.destroy', $topthings->id) }}" method="POST"
