...
@if (!empty($destination))
    <section class="search-top-section">
        <img src="{{ asset('uploads/' . $destination->title . '/' . $destination->banner_image) }}" class="img-fluid"
            alt="{{ $destination->banner_image_seo }}" height="175px">
    ...
    <nav class="container" aria-label="breadcrumb">
        <ol class="breadcrumb tbf-breadcrumb">
            ...
            <li class="breadcrumb-item active text-capitalize" aria-current="page">
                {{ str_replace('-', ' ', $destination->link_name) }}</li>
        </ol>
    </nav>
    ...
    <section class="section-padding border-top">
        <div class="container">
            <div class="row g-md-5">
                <div class="col-md-8">
                    <h1 class="fw-bold mb-3 mb-md-4 h4">{{ $destination->heading }}</h1>
                    <div>
                        <div class="city-flight-list">
                            <div class="row gx-1 gx-md-3 align-items-center">
                                ...
                                <div class="col-7 border-start border-end">
                                    <div class="p-1 p-md-2">
                                        <div class="row gx-1 gx-md-3 align-items-center">
                                            <div class="col-5">
                                                <div class="onwards">
                                                    <small>Departure <span
                                                            class="d-none d-md-inline">From</span></small>
                                                    <p class="text-truncate mb-0">
                                                        {{ $destination->airline_from1 }}</p>
                                                </div>
                                            </div>
                                            <div class="col-2 d-flex justify-content-center">
                                                <div class="">
                                            ...
                                            <div class="col-5">
                                                <div class="destination-city">
                                                    <small>Destination <span
                                                            class="d-none d-md-inline">City</span></small>
                                                    <p class="text-truncate mb-0">{{ $destination->airline_to1 }}
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="col-3 d-flex justify-content-center">
                                    <div class="price-city p-1 p-md-2">
                                        ...
                                        <p class="m-0">£{{ number_format($destination->airline1_price, 0) }}
                                        </p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="city-flight-list">
                            <div class="row gx-1 gx-md-3 align-items-center">
                                        ...
                                        <div class="row gx-1 gx-md-3 align-items-center">
                                            ...
                                            <div class="col-5">
                                                <div class="destination-city">
                                                    <small>Destination <span
                                                            class="d-none d-md-inline">City</span></small>
                                                    <p class="text-truncate mb-0">{{ $destination->airline_to2 }}
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="col-3 d-flex justify-content-center">
                                    <div class="price-city p-1 p-md-2">
                                        <small>Fare From</small>
                                        <p class="m-0">£{{ number_format($destination->airline2_price, 0) }}
                                        </p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="city-flight-list">
                            <div class="row gx-1 gx-md-3 align-items-center">
                                        ...
                                        <div class="row gx-1 gx-md-3 align-items-center">
                                            ...
                                            <div class="col-5">
                                                <div class="destination-city">
                                                    <small>Destination <span
                                                            class="d-none d-md-inline">City</span></small>
                                                    <p class="text-truncate mb-0">{{ $destination->airline_to3 }}
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="col-3 d-flex justify-content-center">
                                    <div class="price-city p-1 p-md-2">
                                        <small>Fare From</small>
                                        <p class="m-0">£{{ number_format($destination->airline3_price, 0) }}
                                        </p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="city-flight-list">
                            <div class="row gx-1 gx-md-3 align-items-center">
                                        ...
                                        <div class="row gx-1 gx-md-3 align-items-center">
                                            ...
                                            <div class="col-5">
                                                <div class="destination-city">
                                                    <small>Destination <span
                                                            class="d-none d-md-inline">City</span></small>
                                                    <p class="text-truncate mb-0">{{ $destination->airline_to4 }}
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="col-3 d-flex justify-content-center">
                                    <div class="price-city p-1 p-md-2">
                                        <small>Fare From</small>
                                        <p class="m-0">£{{ number_format($destination->airline4_price, 0) }}
                                        </p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="city-flight-list">
                            <div class="row gx-1 gx-md-3 align-items-center">
                                        ...
                                        <div class="row gx-1 gx-md-3 align-items-center">
                                            ...
                                            <div class="col-5">
                                                <div class="destination-city">
                                                    <small>Destination <span
                                                            class="d-none d-md-inline">City</span></small>
                                                    <p class="text-truncate mb-0">{{ $destination->airline_to5 }}
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="col-3 d-flex justify-content-center">
                                    <div class="price-city p-1 p-md-2">
                                        <small>Fare From</small>
                                        <p class="m-0">£{{ number_format($destination->airline5_price, 0) }}
                                        </p>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="city-description">
                        {{-- <h2 class="h4">Book Business Class Flights to {{ $destination->title }} at discounted
                            rates</h2> --}}
                ...
                <div class="col-md-4">
                    <div class="multi-fare-section">
                        <div class="class-fare">
                            <h4 class="clr-dark-pink fst-italic mb-3">Package Starting from</h4>
                            <hr>
                            <div class="row py-md-2 px-3 justify-content-center">
                                <div class="col-5 border-bottom">
                                    <div class="price">
                                        <small>First Class</small>
                                        <span>£{{ number_format($destination->first_class_price, 0) }}</span>
                                    </div>
                                </div>
                                <div class="col-5 border-bottom border-start">
                                    <div class="price">
                                        <small>Business Class</small>
                                        <span>£{{ number_format($destination->business_class_price, 0) }}</span>
                                    </div>
                                </div>
                                <div class="col-5">
                                    <div class="price">
                                        <small>Pre. Economy</small>
                                        <span>£{{ number_format($destination->premier_economy_price, 0) }}</span>
                                    </div>
                                </div>
                                <div class="col-5 border-start">
                                    <div class="price">
                                        <small>Economy</small>
                                        <span>£{{ number_format($destination->economy_price, 0) }}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="enquiry-bottom">
                            <p>Enquire for 2024 and 2025 travel dates:</p>
                            <a href="tel:+02037276360"><img src="{{ asset('img/icons/call-white.svg') }}"
                                    alt=""> + 0203
                                727
                                6360</a>
                        </div>
