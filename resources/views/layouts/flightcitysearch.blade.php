...
<body id="pageContent">
    ...
    @if (!empty($destination))
        <section class="search-top-section">
            <img src="{{ asset('uploads/' . $destination->title . '/' . $destination->banner_image) }}"
                class="img-fluid" alt="{{ $destination->banner_image_seo }}" height="175px">
                        ...
                        <div class="col-md-3">
                            <div class="pax-selection" id="passengerTrigger">
                                ...
                                <div class="add-travelers" id="passengerInput">
                                    ...
                                    <div class="row mt-2">
                                        <div class="col-4">
                                            <button class="btn btn-pax-close closeButton"
                ...
                <div class="slide-content">
                    <div class="search-control">
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" id="todestm"
                                placeholder="Enter City / Country" aria-label="Enter City / Country">
                            <span class="input-group-text">
                                <svg clip-rule="evenodd" fill-rule="evenodd" stroke-linejoin="round" width="20"
                                    height="20" stroke-miterlimit="2" viewBox="0 0 24 24"
                                    xmlns="http://www.w3.org/2000/svg">
        ...
        <nav class="container" aria-label="breadcrumb">
            <ol class="breadcrumb tbf-breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Flight to {{ $destination->title }}</li>
            </ol>
        </nav>
        ...
        <section class="section-padding border-top">
            <div class="container">
                <div class="row g-md-5">
                    <div class="col-md-8">
                        <h2 class="fw-bold mb-3 mb-md-4">{{ $destination->heading }}</h2>
                        <div>
                    ...
                    <div class="col-md-4">
                        <div class="multi-fare-section">
                            <div class="class-fare">
                                <h5 class="clr-dark-pink fst-italic mb-3">Package Starting from</h5>
                                <hr>
                            ...
                            <div class="enquiry-bottom">
                                ...
                                <a href="tel:+02037276366"><img src="{{ asset('img/icons/call-white.svg') }}"
                                        alt=""> + 0203
                                    727
                                    6366</a>
                            </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            document.getElementById('departdatemc').value = formatDate(new Date());
            // Set Return Date to current date + 8 days
