                    ...
                    <div class="card-body">
                        <div class="row g-1 align-items-center">
                            <div class="col col-md border-end me-2">
                                ...
                                <p class="mb-0 fs-18 fw-bold">£{{ number_format($destination->first_class_price, 0) }}
                                </p>
                            </div>
                            <div class="col col-md border-end me-2">
                            ...
                            <div class="col col-md">
                                <small>ECONOMY</small>
                                <p class="mb-0 fs-18 fw-bold">£{{ number_format($destination->economy_price, 0) }}</p>
                            </div>
                            <div class="col col-md-3 d-inline-flex justify-content-end">
                                <button
                                    onclick="window.location.href='{{ url('/flight-city-search/' . $destination->title . '/' . $destination->id) }}'"
