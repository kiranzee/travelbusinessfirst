...
<head>
    ...
    <title>{{ $destination->meta_title ?? 'Travel Business First - ' }}</title>
    <meta name="description" content="{{ $destination->meta_description ?? 'Default description for SEO' }}">
    <meta name="keywords" content="{{ $destination->meta_keywords ?? 'default,keywords' }}">
...
<body id="pageContent">
            ...
            <div class="container-fluid pd-left pe-0">
                <div class="d-flex justify-content-between align-items-center px-4 header-left">
                    ...
                    <div class="call-mob order-3 d-md-none">
                        <a href="tel:+02037276360" class="text-decoration-none">
                    ...
                    <div class="offcanvas-body p-0 pt-4 pt-md-0">
                        <ul class="navbar-nav mb-2 mb-lg-0 w-100 align-items-center">
                            ...
                            <li class="nav-item border-md-end">
                                <a class="nav-link px-4  {{ request()->is('flight') ? 'active' : '' }}"
                                    aria-current="page" href="{{ url('/flight') }}">Flights</a>
                            </li>
                            <li class="nav-item border-md-end">
                            ...
                            <li class="nav-item dropdown border-md-end">
                                ...
                                <div class="dropdown-menu desti-dropdown">
                                    <div class="row">
                                        @if ($sortedMenu->isNotEmpty())
                                            @foreach ($sortedMenu as $region => $destinations)
                                                <div class="col-6 col-md-3">
                                                    <div class="mb-3">
                                                        <h6 class="fw-bold clr-dark-pink mb-2">{{ $region }}
                                                        </h6>
                                                        <ul class="d-md-flex flex-md-wrap">
                                                            @foreach ($destinations as $destination)
                                                                <li>
                                                                    <a
                                                                        href="{{ route('flight-city-search.citySearch', ['cityname' => $destination->link_name]) }}">
                                                                        {{ $destination->title }}
                                                                    </a>
                                                                </li>
                                                            @endforeach
                            ...
                            <li class="ms-4 no-nav-link"><a href="https://store.iata.org/ieccacfree" target="_blank">
                                    <img class="img-fluid" src="{{ asset('img/iata-91285611.png') }}"
                                        alt="IATA-91285611"></a>
                            </li>
                            <li class="no-nav-link"><a href="https://www.atol.org/check-for-atol/" target="_blank">
                                    <img class="img-fluid" src="{{ asset('img/atol-10713.webp') }}"
                                        alt="ATOL-10713"></a>
                            </li>
                            <li class="nav-item border-md-end ms-auto pe-3 no-nav-link">
                                <img src="{{ asset('img/icons/phone.svg') }}" alt="">
                                <a href="tel:+02037276360" class="text-decoration-none mx-2">0203 727 6360</a>
                            </li>
    ...
    <div class="bottom-drawer">
        ...
        <div class="d-inline-flex justify-content-end"><a href="https://www.atol.org/check-for-atol/"
                target="_blank">
                <img class="img-fluid w-75" src="{{ asset('img/iata-91285611.png') }}"
                    alt="alt="IATA-91285611""></a>
            <a href="https://www.atol.org/check-for-atol/" target="_blank"><img class="img-fluid w-75"
                    src="{{ asset('img/atol-10713.webp') }}" alt="ATOL-10713"></a>
        </div>
    </div>
