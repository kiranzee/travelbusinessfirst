...
<section class="search-top-section">
    <img src="{{ asset('img/virginatlantic-top-image.webp') }}" class="img-fluid" alt="" height="175px">
...
<nav class="container" aria-label="breadcrumb">
    <ol class="breadcrumb tbf-breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="#">Virgin Atlantic</a></li>
                ...
                <div>
                    ...
                    <div class="flight-description">
                        <div class="info-text">
                            <div class="row">
                                <div class="col-lg-12">
                                    <p><strong>Virgin Atlantic</strong> is a UK based airline which started operations
                                        in 1984 with its first transatlantic flight between London and Newark. Whilst it
                                        shares its name with the Virgin Group, the airline is a separate, independent
                                        entity. It is, however, led by the same charismatic and adventurous business
                                        tycoon, Sir Richard Branson.</p>

                                    <p>Virgin Atlantic is one of the world's most famous airlines. Its distinctive name
                                        and
                                        Virgin Atlantic
                                        branding make it highly recognisable. Virgin Atlantic is the most admired brand
                                        in the vast Virgin stable of companies.
                                        The airline has built a reputation on introducing innovation and in providing
                                        excellent service. The airline was the first to introduce Premium Economy, the
                                        first to introduce a bar for Upper Class passengers and the first to offer
                                        seatback TV in every seat in every cabin. It was also the first to develop a new
                                        generation of fully flatbed seats in
                                    </p>
                                    <p>an inward-facing herringbone configuration. It thrives on its “David” against the
                                        “Goliaths” of the established big airlines emphasising on providing value of
                                        money, quality, fun and innovation. In short, it brings fun and enjoyment in to
                                        travel.
                                    </p>
                                    <p>The airline flies direct to many major destinations such as cities in India,
                                        China, Japan, the USA, the Caribbean, Africa, Hong Kong, the Middle East and
                                        Australia. Virgin Atlantic uses a mixed fleet of Airbus and Boeing wide-body
                                        aircraft comprising Boeing 747s, Boeing 787s, Airbus A340-600s and A330-300s.

                                        Virgin Atlantic has joint ventures with Delta Airlines and Air France / KLM,
                                        offering 300 non-stop flights from 28 UK and European cities to 32 North
                                        American destinations, with a further 250 connections within North America on
                                        Delta.</p>
                                    <p>Travel Business First has great discounts with Virgin Atlantic Airways. Save upto
                                        50% on great destinations flown by Virgin Airways.</p>
                                    <p>We are specialists in providing discounted Virgin Airways tickets. Whether you
                                        are looking for a cheap flight in Business Class, First Class, Premium Economy
                                        or Economy, Travel Business First can save you upto 50%.</p>
                                    <p>Have fun, enjoy your travel and fly with Virgin Airways!</p>
                                </div>
                            </div>
                            <div class="info-text">
                                <div class="row">
                                    <div class="col-lg-4 col-md-12 mb-4 mb-lg-0">
                                        <img src="{{ asset('img/Virgin-atlantic-3.jpg') }}"
                                            class="w-100 shadow-1-strong rounded mb-4"
                                            alt="Virgin Atlantic Business Class" />
                                    </div>

                                    <div class="col-lg-4 mb-4 mb-lg-0">
                                        <img src="{{ asset('img/Virgin-Business-lounge.jpg') }}"
                                            class="w-100 shadow-1-strong rounded mb-4"
                                            alt="Virgin Atlantic Business class" />
                                    </div>

                                    <div class="col-lg-4 mb-4 mb-lg-0">
                                        <img src="{{ asset('img/Virgin-business-class.jpg') }}"
                                            class="w-100 shadow-1-strong rounded mb-4"
                                            alt="Virgin Atlantic Business Class" />
