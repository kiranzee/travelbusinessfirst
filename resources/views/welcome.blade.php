...
<section class="container">
    <form id="flightSearch">
        <div class="search-block">
            <h2 class="fw-bold mb-4 text-truncate">Flights from United Kingdom</h2>
                            ...
                            <div class="dropdown tbf-dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li class="input-group-text">
                                        <input class="form-check-input" id="oneway" type="checkbox" name="route"
                                            value="One way" aria-label="">
                            ...
                            <div id="onwardTrigger" class="col-5 col-md-5">
                                <div class="departure">
                                    <img class="d-none d-md-block" src="{{ asset('img/icons/depart-flight.svg') }}"
                                        alt="">
                                    <div>
                                        <small class="clr-7e text-truncate" id="fromLabel">Departure </small>
                            ...
                            <div id="returnTrigger" class="col-5 col-md-5">
                                <div class="destination">
                                    <img class="d-none d-md-block" src="{{ asset('img/icons/depart-flight.svg') }}"
                                        alt="">
                                    <div>
                                        <small class="clr-7e text-truncate" id="toLabel">Destination </small>
        ...
        <div class="row g-3">
            <div class="col-md-12">
                <div id="ouruspCarousel" class="owl-carousel owl-theme">
                    ...
                    <div class="item">
                        <div class="card">
                            <img class="img-fluid me-3" src="{{ asset('img/icons/call-24.svg') }}" alt="">
                            <p class="mb-0">We are committed to serving you 24/7</p>
                        </div>
                    </div>
                    <div class="item">
                        <div class="card">
                            <img class="img-fluid me-3" src="{{ asset('img/icons/payment.svg') }}" alt="">
...
<script type="text/javascript">
    $(function() {
        ...
        // Initially set return date field state based on selected checkbox
        toggleReturnDate();

        // Listen for changes on the checkboxes
        $('input[name="route"]').on('change', function() {
            // Ensure only one checkbox can be selected at a time
            $('input[name="route"]').not(this).prop('checked', false);
        ...
        function toggleReturnDate() {
            ...
            // Check if "One Way" is selected
            if ($('#oneway').is(':checked')) {
                // Disable and clear return date field if "One Way" is selected
                $('#returndate').val('').prop('disabled', true);
                $('#routeLabel').text('One Way');
                ...
                $('input[name="departdate"]').daterangepicker({
                    ...
                    locale: {
                        cancelLabel: 'Clear',
                        format: 'ddd, D MMM YY' // Optional: format the date as needed
                    }
                });
                ...
                // Enable return date field if "Round Trip" is selected
                $('#returndate').prop('disabled', false);
                $('#routeLabel').text('Round Trip');
                // Set formatted date to input field on page load
                document.getElementById('departdate').value = formatDate(new Date());
