...
<section class="search-top-section">
    <img src="{{ asset('img/singapore-airlines-top-image.webp') }}" class="img-fluid" alt="" height="175px">
...
<nav class="container" aria-label="breadcrumb">
    <ol class="breadcrumb tbf-breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="#">Singapore Airlines</a></li>
                ...
                <div>
                    ...
                    <div class="flight-description">
                        <div class="info-text">
                            <div class="row">
                                <div class="col-lg-12">
                                    <p>Singapore Airlines, from its hub in Singapore, flies to 62 destinations in 32
                                        countries across five continents. Naturally, it has a strong presence in the
                                        Southeast Asian region, which together with its subsidiary SilkAir, connects
                                        Singapore with more international destinations in the region than any other
                                        Southeast Asian airline.</p>

                                    <p>Singapore Airlines is best known for its “Singapore Girl” advertising, a focus on
                                        its on-board staff and its service. This is in contrast to most other airlines,
                                        which tend to Singapore Airlines
                                        emphasise on their aircraft, their on-board features and services in general.
                                        The promotion of the “Singapore Girl” has been very successful and has
                                        differentiated the airline as one providing high quality service
                                        For this reason and others, Singapore Airlines is consistently ranked amongst
                                        the best airlines in the world and is regarded amongst the select few 5 star
                                        airline. It is one of the few airlines that offer five classes of service –
                                        suites, first class, business class, premium economy class, and economy class
                                    </p>

                                    <p> It was the first airline to operate the Airbus 380 and currently operates an all
                                        wide-body aircraft fleet of five aircraft families: Airbus A330, Airbus A350,
                                        Airbus A380, Boeing 777, and Boeing 787, totalling 114 registered aircraft.
                                    </p>
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        <img class="col-md-12 col-sm-12 col-xs-12"
                                            src="{{ asset('img/Singaporeairlines-seatconfiguration.png') }}"
                                            alt="Singapore Airlines">
                                    </div>
                                    <p>The airline has one of the best cabin layouts, offering more space and comfort in
                                        all cabin classes. From Business Class to Economy, the airline provides greater
                                        seat pitch and width.

                                        Travel Business First has great discounts with Singapore Airlines. Save upto 50%
                                        on flights to the far east and Australia offered by Singapore Airlines.
                                    </p>
                                </div>
                            </div>
                            <div class="info-text">
                                <div class="row">
                                    <div class="col-lg-4 col-md-12 mb-4 mb-lg-0">
                                        <img src="{{ asset('img/Singapore-airlines-first-class-suite.jpg') }}"
                                            class="w-100 shadow-1-strong rounded mb-4"
                                            alt="Singapore Airlines First Class" />
                                    </div>

                                    <div class="col-lg-4 mb-4 mb-lg-0">
                                        <img src="{{ asset('img/singapore-airlines_businessclass.jpeg') }}"
                                            class="w-100 shadow-1-strong rounded mb-4"
                                            alt="Singapore Airlines Business class" />
                                    </div>

                                    <div class="col-lg-4 mb-4 mb-lg-0">
                                        <img src="{{ asset('img/singapore-airlines-firstclass.jpg') }}"
                                            class="w-100 shadow-1-strong rounded mb-4"
                                            alt="Sinagpore Airlines Business Class" />
